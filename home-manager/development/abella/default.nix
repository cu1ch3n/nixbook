...
in
{
  ...
  xdg.configFile."sublime-text/Packages/User/Abella.sublime-settings".text = builtins.toJSON {
    "abella.exec" = "${pkgs.abella}/bin/abella";
    "proof_view_mode" = "panel";
  };
  # Sublime Text
  xdg.configFile."sublime-text/Packages/User/Preferences.sublime-settings".text = builtins.toJSON (merge {
    ui = {
      margin = 4;
      gutter = true;
      drag_text = false;
